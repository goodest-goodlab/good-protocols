...
5.	Place horizontally on rotator in incubator for 15 minutes, tape tubes down
	a.	Incubator should be at 33C and rotator should be around 3-4
	b.	shaker should be at 120rpm or between settings 1 and 2 for Lila’s shaker (very gentle shaking)
...
18.	During the above incubation, move to clean room and mix lysis buffers
	...
	d.	Add RTL buffer from Qiagen kit to each tube, amount depends on type of mouse and which tube (for tubes that will hold 2 rounds of sorting: 600 for less fertile mouse, 650 for more fertile mouse; for tubes that will hold 1 round of sorting: 300 for less fertile mouse, 350 for more fertile mouse) (see table)
	e.	Add 15uL BME per mL lysis buffer
	f.	Place tubes in ice bucket  

Labeling and volume example for a more fertile mouse:
...
44.	Go down to sorter; before you go make sure you have these things, and RNase-away them if possible:
	...
	d.	If time, clean up, but if running late or cutting it close for cell sort appointment just deal with essential things and take care of rest later
